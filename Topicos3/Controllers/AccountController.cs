            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await UserManager.SendEmailAsync(user.Id,
                        ...
                        $"Por favor, confirme sua conta clicando <a href=\"{callbackUrl}\">aqui</a>");

                    ViewBag.Message = "Verifique seu e-mail e confirme sua conta. Você deve confirmar antes de fazer login.";
                    return View("Info");
                }
